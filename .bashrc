#sex ~/.bashrc: executed by bash(1) for non-login shells.
...
_PS1='\[\e[1;33m\]\u \[\e[1;32m\]on \h \[\e[1;35m\]\d \@\[\e[0;0m\]\n\[\e[1;36m\][dir.= \w] \#\[\e[1;31m\]$(__git_ps1)\[\e[1;33m\] > \[\e[0;0m\]'
...
# FOR ROOOOT USER --------------------------------------------------------------------------------
_PS1='\[\e[1;31m\]\u \[\e[1;32m\]on \h \[\e[1;35m\]\d \@\[\e[0;0m\]\n\[\e[1;31m\][dir.= \w] \# > \[\e[0;0m\]'
RET_SUCC="\[\033[32;1m\]\342\234\223"
RET_FAIL="\[\033[31;1m\]\342\234\227"
PROMPT_COMMAND='RET=$?; if [[ $RET -eq 0 ]]; then export PS1="${RET_SUCC} ${_PS1}"; else export PS1="${RET_FAIL} ${_PS1}"; fi'
#--------------------------------------------------#
...
#PS1="\[\033]0;\u:${NEW_PWD}\007\]\n\[\033[0;1;97;44m\] \u \[\033[0;34;104m\]\[\033[0;1;97;104m\] \e[38;2;6;18;38m\h \[\033[0;94;107m\]\[\033[0;90;1;107m\] ${NEW_PWD} \[\033[0;97;49m\]\[\033[1;38;5;74m\]"
    #PS1='${debian_chroot:+($debian_chroot)}\[\033]0;\u:${NEW_PWD}\007\]\n\[\033[0;1;97;44m\] \u \[\033[0;34;104m\]\[\033[0;1;97;104m\] \e[38;2;6;18;38m\h \[\033[0;94;107m\]\[\033[0;90;1;107m\] ${NEW_PWD} \[\033[0;97;49m\]\[\033[1;38;5;74m\]\$'
#else
